    ...
    return (
      <div className="aboutMe">
        ...
        <h2 className="header "> Who am I?</h2>
          ...
          <p className="paragraph">I graduated from the Thinkful Coding Bootcamp April 2020. While in Thinkful I have become proficient in HTML5, CSS3, Javascript ES6, jQuery, Reactjs, Nodejs, Express, and PostgreSQL. I wanted to get into coding because I love the challenge it gives me. Not only do I love the challenge of it, but also I love knowing that there are people out there that I can truly help with writing code. Right now, I am really looking forward to continue learning, and become a proficient developer! Currently, I am starting to help in a Covid-19 project, and also learning to build mobile apps using React Native. </p>
